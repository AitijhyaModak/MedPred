...
function Form({
  ...
  return (
    <form
      className="max-[600px]:max-w-[500px] max-w-[900px] mt-10 mx-auto glass animate-fade-in-up delay-700 opacity-0"
    ...
    >
      <Water
        ...
        setEnteredSymptom={setEnteredSymptom}
        setError={setError}
      ></Water>
      <div className="flex flex-col gap-8 px-6 max-[620px]:hidden">
...
function Water({
  ...
  return (
    <div className="min-[620px]:hidden flex flex-col gap-7 max-w-[450px] mx-auto">
      <div className="flex flex-col gap-2 w-full">
        <span
          className={`input-label ${!error.age ? "input-label-error" : ""}`}
        >
      ...
      <div className="flex flex-col gap-2 w-full">
        <span
          className={`input-label ${!error.height ? "input-label-error" : ""}`}
        >
          Height (cm)
        </span>
        <Input
      ...
      <div className="flex flex-col gap-2 w-full">
        <span
          className={`input-label ${!error.weight ? "input-label-error" : ""}`}
        >
          Weight (kg)
        </span>
        <Input
